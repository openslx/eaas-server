...
public class SubSequenceType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "LeftFragment", namespace = "http://www.nationalarchives.gov.uk/pronom/SignatureFile", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RightFragment", namespace = "http://www.nationalarchives.gov.uk/pronom/SignatureFile", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "Shift", namespace = "http://www.nationalarchives.gov.uk/pronom/SignatureFile", type = JAXBElement.class, required = false)
    })
