...
public class EnvironmentContainerDetails {
    ...
    @XmlElement
    private List<EnvironmentContainerDetails.ParentEnvironment> revisions;

    @XmlElement
    private List<EnvironmentContainerDetails.SoftwareInfo> installedSoftwareIds;
    ...
    public EnvironmentContainerDetails(EmilEnvironment emilenv,
        ...
        this.networking = (ContainerNetworkingType) emilenv.getNetworking();
        ...
        {
            EnvironmentContainerDetails.ParentEnvironment p = new EnvironmentContainerDetails.ParentEnvironment();
        ...
        if (machineConf != null) {
            ...
            for(String swId : swIds)
            {
                try {
                    ...
                    EnvironmentContainerDetails.SoftwareInfo info = new EnvironmentContainerDetails.SoftwareInfo();
                    info.id = swId;
    ...
    public List<EnvironmentContainerDetails.ParentEnvironment> getRevisions()
    {
        return revisions;
    }

    public List<EnvironmentContainerDetails.SoftwareInfo> getInstalledSoftwareIds()
    {
