...
/**
 * A Digital File that is associated with a Manifestation.  This entity allows a Digital File to be shared between different manifestations of the same (or different) deliverable units (and, potentially, for the file to have a different path in different cases).
 * 
 * <p>Java-Klasse für typeManifestationFile complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="typeManifestationFile">
 *   &lt;complexContent>
...
@XmlType(name = "typeManifestationFile", propOrder = {
    "fileRef",
    "path"
})
public class TypeManifestationFile {
