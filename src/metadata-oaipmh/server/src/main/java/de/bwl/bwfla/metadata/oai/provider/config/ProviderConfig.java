...
{
	public static final String BASE_KEY_PREFIX = "metadata_provider.";
	...
	{
		ConfigHelpers.check(configs, "List of metadata-provider backends is invalid!");
	...
	public void load(Configuration config) throws ConfigException
	{
		...
		log.info("Loading metadata-provider's configuration...");
		...
		// Configure backends for this instance
		{
			...
			log.info("Loaded " + backends.size() + " provider-backend configuration(s)");
		}
	}
}
